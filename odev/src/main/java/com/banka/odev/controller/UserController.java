...
public class UserController {
	...
	@GetMapping(path = "search/findByUsername")
	public ResponseEntity<UserResponseDto> findByUsername(UserRequestDto user) {
		
		return ResponseEntity.ok(searchService.findByUsername(user));
	}
